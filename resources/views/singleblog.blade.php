                ...
                <div class="col-lg-8 posts-list">
                    <div class="single-post">
                        <div class="feature-img">
                            <img class="img-fluid" src="{{ Storage::url($blog->image) }}" alt="">
                        </div>
                        <div class="blog_details">
                            <h2>{{ $blog->title }}</h2>
                            <ul class="blog-info-link mt-3 mb-4">
                                <li><a href="#"><i class="fa fa-user"></i>{{ $blog->category->title }}</a></li>
                        ...
                        <div class="navigation-area">
                            <div class="row">
                                <div
                                    ...
                                    <div class="thumb">
                                        <a href="#">
                                            <img class="img-fluid" src="{{ asset('img/post/preview.png') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="arrow">
                                ...
                                <div
                                    ...
                                    <div class="thumb">
                                        <a href="#">
                                            <img class="img-fluid" src="{{ asset('img/post/next.png') }}"
                                                alt="">
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <div class="desc">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="date">{{ $comment->created_at->format('d') }}, 2017 at
                                                        3:12 pm</p>
                                                </div>
                                                <div class="reply-btn">
                    ...
                    <div class="comment-form">
                        <h4>Leave a Reply</h4>
                        <form class="form-contact comment_form" action="{{ route('singleblog.store', $blog) }}"
                    ...
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget instagram_feeds">
                            ...
                            <ul class="instagram_row flex-wrap">
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="{{ asset('img/post/post_5.png') }}"
                                            alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="{{ asset('img/post/post_6.png') }}"
                                            alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="{{ asset('img/post/post_7.png') }}"
                                            alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="{{ asset('img/post/post_8.png') }}"
                                            alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="{{ asset('img/post/post_9.png') }}"
                                            alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="{{ asset('img/post/post_10.png') }}"
                                            alt="">
                                    </a>
                                </li>
                            </ul>
